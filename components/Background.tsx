  ...
  return (
    <div onMouseMove={handleMouseMove} className="bg-[#050505] text-white font-sans relative min-h-screen">
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        />
        <div className="absolute top-[5%] left-[10%] w-[500px] h-[500px] bg-blue-600/25 rounded-full blur-[120px] force-animate-blob" />
        <div className="absolute bottom-[5%] right-[10%] w-[450px] h-[450px] bg-indigo-600/25 rounded-full blur-[120px] force-animate-blob force-delay" />
